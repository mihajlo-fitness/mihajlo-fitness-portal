...
export default function JavnaLekcijaPage({ params }) {
  ...
  return (
    <div className="max-w-md md:max-w-2xl mx-auto px-6 py-10 animate-fade-in">
      ...
      <div className="mt-12 rounded-2xl border border-accent/15 bg-accent/[0.03] p-4 text-center">
        <p className="text-[12.5px] text-gray-500">
          Želiš pristup celoj biblioteci i lični plan?{" "}
          <Link href="/coaching" className="font-semibold text-accent">
            Pogledaj pakete →
          </Link>
        </p>
      </div>
